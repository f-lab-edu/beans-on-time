...
public class PauseSubscriptionServiceTest {
    ...
    @InjectMocks
    PauseSubscriptionService pauseSubscriptionService;

    @Test
    void 일시정지_시킨_구독을_저장한다() {
        // given
        PauseSubscriptionCommand command = new PauseSubscriptionCommand(new SubscriptionId(UUID.randomUUID()), new CustomerId(1L));
